 ...
 * Description:
 */
public class ColorFilter extends Shape{
    //folat缓冲区
    ...
    public ColorFilter() {
        mBitmap =BitmapFactory.decodeResource(Myapp.app.getResources(),R.mipmap.fengj);
    }


    @Override
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        mProgramId= createProgram(Myapp.app.getResources(), "filter/default_vertex.sh", "filter/color_fragment.sh");
        //通过OpenGL程序句柄查找获取顶点着色器中的位置句柄
        mPositionId = GLES20.glGetAttribLocation(mProgramId, "vPosition");
        //获取变换矩阵vMglHUxyatrix成员句柄
        ...
        hIsHalf=GLES20.glGetUniformLocation(mProgramId,"vIsHalf");
        glHUxy=GLES20.glGetUniformLocation(mProgramId,"uXY");
        hChangeType=GLES20.glGetUniformLocation(mProgramId,"vChangeType");
        hChangeColor=GLES20.glGetUniformLocation(mProgramId,"vChangeColor");
