...
import edu.wzy.opengl.filter.GrayFilter;
import edu.wzy.opengl.filter.NoFilter;
import edu.wzy.opengl.filter.WaterMarkFilter;
import edu.wzy.opengl.filter.ZipPkmAnimationFilter;
 ...
 * Description:
 */
public class Camera2Activity extends BaseActivity implements edu.wzy.opengl.camera.FrameCallback {

    private SurfaceView mSurfaceView;
    private edu.wzy.opengl.camera.TextureController mController;
    private edu.wzy.opengl.camera.Renderer mRenderer;
    ...
    protected void onFilterSet(edu.wzy.opengl.camera.TextureController controller){
    ...
    private Runnable initViewRunnable = new Runnable() {
        ...
        public void run() {
            ...
            mController = new edu.wzy.opengl.camera.TextureController(Camera2Activity.this);
...
//            mController.addFilter(filter);
    ...
    private class Camera1Renderer implements edu.wzy.opengl.camera.Renderer {
    ...
    private class Camera2Renderer implements edu.wzy.opengl.camera.Renderer {
