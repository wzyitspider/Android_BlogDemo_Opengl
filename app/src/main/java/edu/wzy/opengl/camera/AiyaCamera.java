 ...
 * Description:
 */
public class AiyaCamera implements edu.wzy.opengl.camera.IAiyaCamera {

    private edu.wzy.opengl.camera.IAiyaCamera.Config mConfig;
    ...
    public AiyaCamera(){
        this.mConfig=new edu.wzy.opengl.camera.IAiyaCamera.Config();
...
//            param.setRecordingHint(true);
            ...
            Log.e("wzy","camera previewSize:"+mPreSize.x+"/"+mPreSize.y);
        }
    }
    ...
    public void setConfig(edu.wzy.opengl.camera.IAiyaCamera.Config config) {
        this.mConfig=config;
    }
    ...
    public void setOnPreviewFrameCallback(final edu.wzy.opengl.camera.IAiyaCamera.PreviewFrameCallback callback) {
        if(mCamera!=null){
    ...
    public void setOnPreviewFrameCallbackWithBuffer(final AiyaCamera.PreviewFrameCallback callback) {
        if(mCamera!=null){
            Log.e("wzy","Camera set CallbackWithBuffer");
