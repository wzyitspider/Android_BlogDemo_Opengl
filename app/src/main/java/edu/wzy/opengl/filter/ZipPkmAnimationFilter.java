...
import edu.wzy.opengl.etc.ZipPkmReader;
import edu.wzy.opengl.utils.Gl2Utils;
import edu.wzy.opengl.utils.MatrixUtils;

/**
 * Description:
 */
public class ZipPkmAnimationFilter extends edu.wzy.opengl.filter.AFilter {
    ...
    private edu.wzy.opengl.filter.NoFilter mBaseFilter;
    ...
    public ZipPkmAnimationFilter(Resources mRes) {
        super(mRes);
        mBaseFilter=new edu.wzy.opengl.filter.NoFilter(mRes);
